        ...
        <div class="row py-3">
          ...
          <div class="col-md-8 col-12">
            <div class="bg-white py-3 text-center">
              ...
              <p>2025/3/20</p>
              <!--記事タイトル-->
              <h1 class="px-3 pb-3 font-weight-bolder">ピックアップコンテンツ1ピックアップコンテンツ1ピックアップコンテンツ1</h1>
              <!--カテゴリー-->
          ...
          <div class="col-md-4 col-12">
            ...
            <div class="container bg-white mb-5 py-5">
              <div class="mx-5">
                <img class="img-fluid rounded-circle" src="image/blue.jpg" alt="">
              </div>
              <div class="text-center">
                <h4 class="d-inline-block py-3 border-bottom border-info">かさはらつばさ</h4>
              </div>
            ...
            <div class="container bg-white mb-5 py-5">
              ...
              <div class="pb-5">             
                <!--サムネイル-->
                <div class="pb-3">
                  <img class="img-fluid" src="image/yelow.jpg" alt="">
                </div>
                <!--記事タイトル-->
              ...
              <div class="pb-5">             
                <!--サムネイル-->
                <div class="pb-3">
                  <img class="img-fluid" src="image/sea.jpg" alt="">
                </div>
                <!--記事タイトル-->
                <h5 class="h5">ピックアップコンテンツ1ピックアップコンテンツ1ピックアップコンテンツ1</h5>
              </div>
              <div class="pb-5">             
                <!--サムネイル-->
                <div class="pb-3">
                  <img class="img-fluid" src="image/space.jpg" alt="">
                </div>
                <!--記事タイトル-->
                <h5 class="h5">ピックアップコンテンツ1ピックアップコンテンツ1ピックアップコンテンツ1</h5>
              </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 col-12">
              ...
              <a class="twitter-timeline" data-lang="ja" data-height="600" href="Xリンク">Tweets by ○○</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
            </div>
          </div>
        </div>
        <div class="bg-dark text-white text-center p-3">
          Copyright - tsubasa kasahara, 2025 All Rights Reserved.
        </div>
      </footer>
    </main>
